...
sentences = ["I talked to Sam.", 
             ...
             "She will vote for Sam."]

qkey_dict = dict()
qkey_dict['PERSON'] = 'Who'
qkey_dict['PLACE']  = 'Where'
qkey_dict['TIME']   = 'When'
qkey_dict['THING']  = 'What'
qkey_dict['REASON'] = 'Why'
qkey_dict['DEGREE'] = 'How'
